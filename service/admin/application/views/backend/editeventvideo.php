<div class="row">
    <div class="col s12">
    <h4 class="pad-left-15">Editar Evento con Video</h4>
    </div>
</div>
<div class="row">
    <form class="col s12" method="post" action="<?php echo site_url('site/editEventVideoSubmit');?>" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <a href="<?php echo site_url('site/viewEventVideo?id=').$this->input->get('eventid'); ?>" class="btn btn-secondary waves-effect waves-light red">Cancelar</a>
            </div>
        </div>
            </div>
        </div>
