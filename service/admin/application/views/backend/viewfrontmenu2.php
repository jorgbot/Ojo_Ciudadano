        ...
        <div class="row">
            <div class="col s12 dragable">
                <div class="row">
                    ...
                    <div class="col m6 l6">
                        <a href="#" class="saveOrdering blue darken-4 btn waves-effect waves-light" style="float: right;margin-top: 15px;"><i class='material-icons propericon'>save</i> Guardar</a>
                    </div>
                </div>
                <div class="row">
