<div class="row">
    ...
    <h4 class="pad-left-15">Crear Galeria de Imagenes</h4>
        ...
        <form class="col s12" method="post" action="<?php echo site_url('site/createGalleryImageSubmit');?>" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="input-field col s6">
                    <label for="alt">Descripcion</label>
          ...
          <div class="row">
              <div class="col s6">
                ...
                <div class="col-sm-4">
                    ...
                    <a href="<?php echo site_url('site/viewGalleryImage?id=').$this->input->get('id'); ?>" class="btn btn-secondary waves-effect waves-light red">Cancelar</a>
                </div>
            </div>
              </div>
          </div>
