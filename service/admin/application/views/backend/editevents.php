<div class="row">
    <div class="col s12">
    <h4 class="pad-left-15">Editar Eventos</h4>
    </div>
</div>
<div class="row">
         ...
         <div class="row">
            ...
            <div class="row">
                 <div class="col s12 m8">
                        ...
                        <textarea id="some-textarea" name="content" placeholder="Ingresar Texto ..."><?php echo set_value('content', $before->content);?></textarea>
                 </div>
...
<div class="row">
    <div class="col s12 m6">
        <div class=" form-group">
                ...
                <a href="<?php echo site_url('site/viewEvents'); ?>" class="btn btn-secondary waves-effect waves-light red">Cancelar</a>
            </div>
    </div>
</div>
...
<script>
    $(document).ready(function () {
          $(".clearimg").click(function () {
            if (confirm("Segur que quieres borrar la imagen!") == true) {
