<div class="row">
	<div class="col s12">
		<h4 class="pad-left-15">Editar Slider</h4></div>
    ...
    ?>">
				...
				<div class="file-path-wrapper">
					<input class="file-path validate image1" type="text" placeholder="Subir o cambiar imagen" value="<?php echo set_value('image', $before->image);?>">
				</div>
		...
		<div class=" form-group">
			<div class="row">
				<div class="col m6 s12">
					...
					<a href="<?php echo site_url('site/viewSlider'); ?>" class="btn btn-secondary waves-effect waves-light red">Cancelar</a>
				</div>
			</div>
		</div>
	</form>
