    ...
    <div class="col s12">
        <div class="row">
            <div class="col s12 dragable">
                <div class="row">
                    <div class="col m6 l6">
                        <h5 class="panel-title">Lista de Eventos con Video</h5>
                    </div>
                    <div class="col m6 l6">
...
function drawtable(resultrow) {
      return "<li class='collection-item avatar' data-id='"+resultrow.id+"'><i class='material-icons circle red'>play_arrow</i><span class='title'>" + resultrow.url + "</span><p>" + resultrow.status + "</p><a class='secondary-content blue-text text-darken-4' href='<?php echo site_url('site/editEventVideo?id=');?>" + resultrow.id + "&eventid=" + resultrow.eventid + "'><i class='material-icons'>mode_edit</i></a><a class='secondary-content red-text' style='top:50px;' onclick=\"return confirm('Are you sure you want to delete?');\" href='<?php echo site_url('site/deleteEventVideo?id='); ?>" + resultrow.id + "&eventid=" + resultrow.eventid +"'><i class='material-icons propericon'>delete</i></a></li>";
    }
