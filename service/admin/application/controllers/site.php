...
class Site extends CI_Controller
{
    ...
    public function viewGalleryJson()
    {
        ...
        $elements[2]->sort = '1';
        $elements[2]->header = 'Estado';
        $elements[2]->alias = 'status';
        $elements[3] = new stdClass();
        $elements[3]->field = '`webapp_gallery`.`name`';
        $elements[3]->sort = '1';
        $elements[3]->header = 'Nombre';
    ...
    public function viewGalleryImageJson()
    {
        ...
        $elements[4]->sort = '1';
        $elements[4]->header = 'Imagen';
        $elements[4]->alias = 'image';
        $elements[5] = new stdClass();
        $elements[5]->field = '`webapp_galleryimage`.`gallery`';
        $elements[5]->sort = '1';
        $elements[5]->header = 'GaleriaID';
    ...
    public function viewVideoGalleryVideoJson()
    {
        ...
        $elements[3]->field = '`webapp_videogallery`.`name`';
        $elements[3]->sort = '1';
        $elements[3]->header = 'Galeria Videos';
    ...
    public function viewEventsJson()
    {
        ...
        $elements[3]->sort = '1';
        $elements[3]->header = 'Marca de tiempo';
    ...
    public function viewNotificationUserJson()
    {
        ...
        $elements[1]->sort = '1';
        $elements[1]->header = 'Notificación';
        $elements[1]->alias = 'notification';
        $elements[2] = new stdClass();
        $elements[2]->field = '`user`.`name`';
        $elements[2]->sort = '1';
        $elements[2]->header = 'Usuario';
    ...
    public function viewBlogJson()
    {
        ...
        $elements[4]->sort = '1';
        $elements[4]->header = 'Marca de tiempo';
